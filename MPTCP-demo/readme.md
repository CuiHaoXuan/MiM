...
4. mim_Improved-MPTCP-MDR.mp4: to verify the feasibility of Improved MPTCP in MANETs, M1 sends the file /system/xbin/unzip (197952 Bytes) to M5, you can find multiple sub-paths used to transfer data.
